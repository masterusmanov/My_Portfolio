<template>
    <div class="h-[70px] flex justify-between items-center gap-6">
        <div  class="display-none">
            <h1 class="text-white text-xl font-bold ml-3">Elyor Usmanov</h1>
        </div>
        <div id="name" class="justify-end mr-3">
            ...
            <NavbarStyle class="text-[10px] hidden"/>
        </div>
    </div>
</template>

<script setup>
    import NavbarStyle from '../NavbarStyle/NavbarStyle.vue';
</script>
